...
class GridBot:
    ...
    def __init__(self,uppershare=0,lowershare=0,money=10000):
        ...
        self.contractLower = api.Contracts.Stocks[self.lowperid]
                
    def updateOrder(self,BidUpper,AskUpper,Bidlower,Asklower):
...
quantity=df_positions.loc[df_positions['code'] == '1229']['quantity']
if(quantity.size==0):
    quantity=0
else:
...
trade = api.place_order(contract_006208, order)
...
for i in range(0,len(tradelist),1):
    ...
    cond2=trade.contract.code=='006208'
    if(cond1 and cond2):
        trade006208.append(thistrade)

#targetprice=78.5
#targetquantity=100
#api.update_order(trade=trade006208[0], price=targetprice, qty=targetquantity)
api.cancel_order(trade=trade006208[0])
