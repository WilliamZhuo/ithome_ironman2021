...
Grid=strategy_Grid()
retGrid=strategy_optimize(kbars_daily,Grid,list_Grid_range)
...
retTW,retseriesTW=backtest_signal(TW_open,buyTW,spread=0.0000176)
retUS,retseriesUS=backtest_signal(US_open,buyUS,spread=0.0000176)
retseries=(retseriesTW-1.0)+(retseriesUS-1.0)+1.0
prefixProfit=prefixProd(retseries)
plt.plot(prefixProfit,color='green')
#plt.plot(buyTW,color='red')
print('strategyMDD:',calculatMDD(prefixProfit))
print('USMDD:',calculatMDD(US_close))
print('TWMDD:',calculatMDD(TW_close))
