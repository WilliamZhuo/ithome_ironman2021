...
dayopen0050=getStockDailyPrice(stockid='0050',start='2010-01-01',end='2021-09-02',col='Open')
dayclose0050=getStockDailyPrice(stockid='0050',start='2010-01-01',end='2021-09-02',col='Close')
...
list_SAR_range=\
    [np.arange(0.02,0.22,0.01)\
     ,np.arange(0.2,0.4,0.1)]
ret3=strategy_optimize(kbars_daily,SAR,list_SAR_range)